...
public interface OpIntf {
    ...
    default void putIpArg(String field_name, IPBase ip){
        assert ip != null;
    ...
    default IPBase IPArg(String field_name){
        return IPBase.IPOf(field_name);
    }

    default IPBase IDArg(String field_name){
        return IPBase.IDOf(field_name);
    }
    @Override
    String toString();
}
