...
public class RIP extends AbstractNode {
    ...
    public void initFiled() {
        ...
        version = null; //abrType if it's not ABR, this field is null
        update = 0; //spfScheduleDelayMsecs
        timeout = 50; //holdtimeMinMsecs
        garbage = 5000; //holdtimeMaxMsecs
        metric = 10;//FIXME this default arg is not right
        distance = 10;//FIXME this default arg is not right
    }
}
