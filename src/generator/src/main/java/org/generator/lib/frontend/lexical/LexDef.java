...
public class LexDef {
    ...
    static {
        var lexical_seed = new Object[][]{
                ...
                {BCHANELNOINTEFERING, "babel channel noninterfering"},
                ...
                {BMAXRTT, "babel max-rtt-penalty {NUM(0-65535)}"},
                ...
                {NOBCHANELNOINTEFERING, "no babel channel noninterfering"},
                ...
                {NOBMAXRTT, "no babel max-rtt-penalty {NUM(0-65535)}"},
