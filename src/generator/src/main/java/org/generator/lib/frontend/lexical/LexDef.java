...
public class LexDef {
    ...
    static {
        var lexical_seed = new Object[][]{
                ...
                {LSPREFRESHINTERVAL,"lsp-refresh-interval {NAME(level-1,level-2)} {NUM(1-60)}"},
                ...
                {FRPRIORITYLIMIT, "fast-reroute priority-limit {NAME(critical,high,medium)} level-1"},
                {FRLFATIEBREAKER,"fast-reroute lfa tiebreaker {NAME(downstream,lowest-backup-metric,node-protecting)} index {NUM(1-255)} level-1"},
                ...
                {REDISTRIBUTETABLE,"redistribute {NAME(ipv4,ipv6)} table {NUM(1-65535)} level-1 metric {NUM2(0-16777215)}"},
                ...
                {NOLSPREFRESHINTERVAL,"no lsp-refresh-interval {NAME(level-1,level-2)} {NUM(1-60)}"},
                ...
                {NOFRPRIORITYLIMIT, "no fast-reroute priority-limit {NAME(critical,high,medium)} level-1"},
                {NOFRLFATIEBREAKER,"no fast-reroute lfa tiebreaker {NAME(downstream,lowest-backup-metric,node-protecting)} index {NUM(1-255)} level-1"},
                ...
                {NOREDISTRIBUTETABLE,"no redistribute {NAME(ipv4,ipv6)} table {NUM(1-65535)} level-1 metric {NUM2(0-16777215)}"},
