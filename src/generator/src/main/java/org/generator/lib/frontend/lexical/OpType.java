...
//    }
    ...
    public boolean isUnsetOp(){
        return  isZEBRAUnsetOp() || isOSPFUnsetOp() || isRIPUnsetOp() || isISISUnsetOp() || isFABRICUnsetOp();
    }
    ...
    public boolean isSetOp(){
        return isZEBRASetOp() || isOSPFSetOp() || isRIPSetOp() || isISISSetOp() || isFABRICSetOp();
    }
    ...
    public boolean isRouterOp(){
        return isZEBRARouterOp() || isOSPFRouterOp() || isRIPRouterOp() || isISISRouterOp() || isFABRICRouterOp();
    }
    ...
    public boolean isIntfOp(){
        return isZEBRAIntfOp() || isOSPFIntfOp() || isRIPIntfOp() || isISISIntfOp() || isFABRICIntfOp();
    }

    public static Set<OpType> OSPFOps, RIPOps, ISISOps, FABRICOps;
    public static List<OpType> OSPFIntfSetOps, OSPFRouterSetOps, RIPRouterSetOps, RIPIntfSetOps, ISISRouterSetOps, ISISIntfSetOps , FABRICRouterSetOps, FABRICIntfSetOps;
    //MULTI:
    static{
